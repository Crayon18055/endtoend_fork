...
from small_train import config_dict
...
if __name__ == "__main__":
    ...
    if data_source == "fulldata":
        ...
        timelog = os.path.splitext(os.path.basename(checkpoint_path))[0].replace("model_final_", "")
        
        train_data_dir = os.path.join("smalldata", timelog)
